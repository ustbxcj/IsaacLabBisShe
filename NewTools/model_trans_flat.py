...
# from source.MyProject.MyProject.tasks.manager_based.WalkTest.agents.rsl_rl_ppo_cfg import Go2WalkFlatPPORunnerCfg
...
# )
from MyProject.tasks.manager_based.WalkTest.agents.rsl_rl_ppo_cfg import Go2WalkFlatPPORunnerCfg
