...
from .config.terrain import BOX_TERRAINS_CFG
from .config.terrain import EASY_PIT_TERRAINS_CFG
from .config.terrain import MEDIUM_PIT_TERRAINS_CFG
from .config.terrain import HARD_PIT_TERRAINS_CFG
from .config.terrain import ROUGH_TERRAINS_CFG
# from .config.terrain import NAVIGATION_PIT_TERRAINS_CFG
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    #下面是采用地形生成器的方式，可能难度较大

    # terrain = TerrainImporterCfg(
    #     prim_path="/World/ground",
    #     terrain_type="generator",
    #     terrain_generator=EASY_PIT_TERRAINS_CFG,  # 使用坑洞地形
    #     max_init_terrain_level=8,  # 更多难度级别
    #     collision_group=-1,
    #     physics_material=sim_utils.RigidBodyMaterialCfg(
    #         friction_combine_mode="multiply",
    #         restitution_combine_mode="multiply",
...
@configclass
class NaviFunTaskEnvCfg(ManagerBasedRLEnvCfg):
